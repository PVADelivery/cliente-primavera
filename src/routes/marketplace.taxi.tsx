...
import { ArrowLeft, MapPin, CheckCircle2, Car, Bike, Navigation, X, Check, MapPinned, Maximize2, Loader2 } from "lucide-react";
    ...
    if (localMatches.length < 4 && query.trim().length >= 3) {
      ...
      searchTimeout.current = setTimeout(async () => {
        try {
          ...
          console.warn("Erro no fallback Nominatim:", err);
        } finally {
          setSearchingPickup(false);
          setSearchingDropoff(false);
        }
