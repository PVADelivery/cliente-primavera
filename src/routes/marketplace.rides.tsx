          ...
          el.innerHTML = `
            ...
            <div class="relative w-11 h-14 flex items-center justify-center filter drop-shadow-[0_6px_10px_rgba(0,0,0,0.45)]">
              <svg width="44" height="56" viewBox="0 0 44 56" fill="none" class="absolute inset-0">
                <defs>
                  <linearGradient id="pinBodyGradCust" x1="0" y1="0" x2="44" y2="56" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stop-color="#ffb703"/>
                    <stop offset="40%" stop-color="#fb8500"/>
                    <stop offset="100%" stop-color="#d00000"/>
                  </linearGradient>
                  <linearGradient id="pinRingGradCust" x1="0" y1="0" x2="44" y2="44" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stop-color="#ffb703"/>
                ...
                <path d="M22 0C9.849 0 0 9.849 0 22C0 35.5 17.5 51.5 22 56C26.5 51.5 44 35.5 44 22C44 9.849 34.151 0 22 0Z" fill="url(#pinBodyGradCust)"/>
                
                <!-- Borda laranja destacada -->
                <circle cx="22" cy="22" r="17.5" fill="url(#pinRingGradCust)"/>
