          ...
          el.innerHTML = `
            ...
            <div class="relative w-10 h-12 flex items-center justify-center filter drop-shadow-[0_4px_6px_rgba(0,0,0,0.35)]">
              <svg width="36" height="44" viewBox="0 0 40 48" fill="none" class="absolute inset-0">
                <defs>
                  <linearGradient id="pinGradCust" x1="0" y1="0" x2="40" y2="48" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stop-color="#fbbf24"/>
                    <stop offset="35%" stop-color="#f59e0b"/>
                    <stop offset="100%" stop-color="#d97706"/>
                  </linearGradient>
                </defs>
                <path d="M20 0C8.954 0 0 8.954 0 20C0 31.5 16 45 20 48C24 45 40 31.5 40 20C40 8.954 31.046 0 20 0Z" fill="url(#pinGradCust)"/>
