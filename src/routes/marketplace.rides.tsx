    ...
    import("maplibre-gl").then((mod: any) => {
      ...
      try {
        ...
        const createVehicleMarkerElement = (vehType: string) => {
          ...
          el.innerHTML = `
            <div class="absolute w-14 h-14 rounded-full bg-amber-500/35 animate-ping"></div>
            <div class="relative w-12 h-12 rounded-full bg-gradient-to-tr from-amber-500 via-amber-400 to-yellow-300 text-slate-950 font-black flex items-center justify-center shadow-[0_0_25px_rgba(245,158,11,0.95)] border-2 border-white">
              ${isTaxi ? `
              ...
              ` : `
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
                  ...
                  <path d="M6 17.5l3.8-6.5h4.2l3 6.5"/>
                  <path d="M9.8 11L7.5 6.5H5"/>
                  <path d="M14 11l2.2-4.5h3.8"/>
                  <path d="M9 14h5.5"/>
                </svg>
              `}
            </div>
